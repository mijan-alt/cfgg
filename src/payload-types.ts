...
export interface MissionAndVisionBlock {
  ...
  media: number | Media;
  /**
   * Choose whether the image appears on the left or right on desktop.
   */
...
export interface Donation {
  ...
  /**
   * Paystack reference or other payment processor transaction ID
   */
  transactionId?: string | null;
  /**
   * Donor wants to stay informed about our work
   */
  stayInformed?: boolean | null;
  /**
   * Donor is interested in volunteering
   */
  volunteerInterest?: boolean | null;
  donatedAt?: string | null;
  /**
   * IP address of the donor (for fraud prevention)
   */
  ...
  /**
   * Mark as anonymous donation for public displays
   */
  isAnonymous?: boolean | null;
  /**
   * Whether this donation is tax deductible
   */
  taxDeductible?: boolean | null;
  /**
   * Receipt has been sent to donor
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "missionAndVisionBlock_select".
 */
export interface MissionAndVisionBlockSelect<T extends boolean = true> {
  heading?: T;
  description?: T;
  media?: T;
  imagePosition?: T;
